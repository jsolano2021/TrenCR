...
namespace TrenCR.Controllers
{
    public class RutasController : Controller
    {
        ...
        public RutasController(TrenCRContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Capacidad,Estado")] Ruta ruta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Capacidad,Estado")] Ruta ruta)
        {
            if (id != ruta.Id)
            {
                return NotFound();
